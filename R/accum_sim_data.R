#' @title Accumulate simulated data
#' @author Marina Papadopoulou
#' @description Goes through a simulation set (list of lists of dataframes) and joins together experiments
#' with the same parameterization, adding their simulation ids in the sim_info dataframe of each.
#' @param data_lists list of lists of dataframes (model output) from several simulation runs.
#' @return a new list of lists, with some simulation runs merged.
#' @export
